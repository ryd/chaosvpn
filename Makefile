...
SRC = tinc.c fs.c parser.c tun.c y.tab.c lex.yy.c config.c strnatcmp.c daemon.c crypto.c ar.c uncompress.c log.c secmisc.c $(STRINGSRC) $(HTTPLIBSRC)
HEADERS = list.h strnatcmp.h version.h y.tab.h httplib/httplib.h string/string.h
