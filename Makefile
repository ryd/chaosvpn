...
SRC = tinc.c fs.c parser.c tun.c y.tab.c lex.yy.c config.c settings.c strnatcmp.c daemon.c crypto.c ar.c uncompress.c $(STRINGSRC) $(HTTPLIBSRC)
HEADERS = ar.h crypto.h daemon.h fs.h list.h main.h parser.h config.h settings.h strnatcmp.h tinc.h tun.h uncompress.h version.h y.tab.h httplib/httplib.h string/string.h
